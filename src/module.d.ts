...
export namespace components {
  ...
  export class ColumnDefinition extends React.Component<
...
export interface GriddleComponents {
  ...
  LayoutEnhancer?: (
    OriginalComponent: GriddleComponent<any>
  ) => GriddleComponent<any>;
  LayoutContainer?: (
    OriginalComponent: GriddleComponent<any>
  ) => GriddleComponent<any>;
  ...
  StyleContainerEnhancer?: (
    OriginalComponent: GriddleComponent<any>
  ) => GriddleComponent<any>;

  Filter?: GriddleComponent<components.FilterProps>;
  FilterEnhancer?: (
    OriginalComponent: GriddleComponent<components.FilterProps>
  ) => GriddleComponent<components.FilterProps>;
  FilterContainer?: (
    OriginalComponent: GriddleComponent<components.FilterProps>
  ) => GriddleComponent<components.FilterProps>;
  ...
  SettingsWrapperEnhancer?: (
    OriginalComponent: GriddleComponent<components.SettingsWrapperProps>
  ) => GriddleComponent<components.SettingsWrapperProps>;
  SettingsWrapperContainer?: (
    OriginalComponent: GriddleComponent<components.SettingsWrapperProps>
  ) => GriddleComponent<components.SettingsWrapperProps>;
  SettingsWrapperContainerEnhancer?: (
    OriginalComponent: GriddleComponent<components.SettingsWrapperProps>
  ) => GriddleComponent<components.SettingsWrapperProps>;

  SettingsToggle?: GriddleComponent<components.SettingsToggleProps>;
  SettingsToggleEnhancer?: (
    OriginalComponent: GriddleComponent<components.SettingsToggleProps>
  ) => GriddleComponent<components.SettingsToggleProps>;
  SettingsToggleContainer?: (
    OriginalComponent: GriddleComponent<components.SettingsToggleProps>
  ) => GriddleComponent<components.SettingsToggleProps>;
  SettingsToggleContainerEnhancer?: (
    OriginalComponent: GriddleComponent<components.SettingsToggleProps>
  ) => GriddleComponent<components.SettingsToggleProps>;

  Settings?: GriddleComponent<components.SettingsProps>;
  SettingsEnhancer?: (
    OriginalComponent: GriddleComponent<components.SettingsProps>
  ) => GriddleComponent<components.SettingsProps>;
  SettingsContainer?: (
    OriginalComponent: GriddleComponent<components.SettingsProps>
  ) => GriddleComponent<components.SettingsProps>;
  SettingsContainerEnhancer?: (
    OriginalComponent: GriddleComponent<components.SettingsProps>
  ) => GriddleComponent<components.SettingsProps>;
  ...
  TableEnhancer?: (
    OriginalComponent: GriddleComponent<components.TableProps>
  ) => GriddleComponent<components.TableProps>;
  TableContainer?: (
    OriginalComponent: GriddleComponent<components.TableProps>
  ) => GriddleComponent<components.TableProps>;
  ...
  TableHeadingEnhancer?: (
    OriginalComponent: GriddleComponent<components.TableHeadingProps>
  ) => GriddleComponent<components.TableHeadingProps>;
  TableHeadingContainer?: (
    OriginalComponent: GriddleComponent<components.TableHeadingProps>
  ) => GriddleComponent<components.TableHeadingProps>;
  TableHeadingContainerEnhancer?: (
    OriginalComponent: GriddleComponent<components.TableHeadingProps>
  ) => GriddleComponent<components.TableHeadingProps>;

  TableHeadingCell?: GriddleComponent<components.TableHeadingCellProps>;
  TableHeadingCellEnhancer?: (
    OriginalComponent: GriddleComponent<components.TableHeadingCellProps>
  ) => GriddleComponent<components.TableHeadingCellProps>;
  TableHeadingCellContainer?: (
    OriginalComponent: GriddleComponent<components.TableHeadingCellProps>
  ) => GriddleComponent<components.TableHeadingCellProps>;
  TableHeadingCellContainerEnhancer?: (
    OriginalComponent: GriddleComponent<components.TableHeadingCellProps>
  ) => GriddleComponent<components.TableHeadingCellProps>;

  TableBody?: GriddleComponent<components.TableBodyProps>;
  TableBodyEnhancer?: (
    OriginalComponent: GriddleComponent<components.TableBodyProps>
  ) => GriddleComponent<components.TableBodyProps>;
  TableBodyContainer?: (
    OriginalComponent: GriddleComponent<components.TableBodyProps>
  ) => GriddleComponent<components.TableBodyProps>;
  TableBodyContainerEnhancer?: (
    OriginalComponent: GriddleComponent<components.TableBodyProps>
  ) => GriddleComponent<components.TableBodyProps>;

  Row?: GriddleComponent<components.RowProps>;
  RowEnhancer?: (
    OriginalComponent: GriddleComponent<components.RowProps>
  ) => GriddleComponent<components.RowProps>;
  RowContainer?: (
    OriginalComponent: GriddleComponent<components.RowProps>
  ) => GriddleComponent<components.RowProps>;
  RowContainerEnhancer?: (
    OriginalComponent: GriddleComponent<components.RowProps>
  ) => GriddleComponent<components.RowProps>;

  Cell?: GriddleComponent<components.CellProps>;
  CellEnhancer?: (
    OriginalComponent: GriddleComponent<components.CellProps>
  ) => GriddleComponent<components.CellProps>;
  CellContainer?: (
    OriginalComponent: GriddleComponent<components.CellProps>
  ) => GriddleComponent<components.CellProps>;
  CellContainerEnhancer?: (
    OriginalComponent: GriddleComponent<components.CellProps>
  ) => GriddleComponent<components.CellProps>;
  ...
  PreviousButtonContainerEnhancer?: (
    OriginalComponent: GriddleComponent<any>
  ) => GriddleComponent<any>;
}
...
export type GriddleFilter =
  | string
  | RowFilter
  | PropertyBag<string | RowFilter>;

export interface GriddleActions
  extends PropertyBag<ActionCreator<any> | undefined> {
