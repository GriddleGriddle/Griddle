	...
	var Griddle = React.createClass({
	  ...
	  verifyExternal: function verifyExternal() {
	    if (this.props.useExternal === true) {
	      ...
	      //TODO: Use PropTypes instead of this...
	      if (this.props.externalSetPage === null) {
	        throw 'useExternal is set to true but there is no externalSetPage function specified.';
	      }

	      if (this.props.externalChangeSort === null) {
	        throw 'useExternal is set to true but there is no externalChangeSort function specified.';
	      }

	      if (this.props.externalSetFilter === null) {
	        throw 'useExternal is set to true but there is no externalSetFilter function specified.';
	      }

	      if (this.props.externalSetPageSize === null) {
	        throw 'useExternal is set to true but there is no externalSetPageSize function specified.';
	      }

	      if (this.props.externalMaxPage === null) {
	        throw 'useExternal is set to true but externalMaxPage is not set.';
	      }

	      if (this.props.externalCurrentPage === null) {
	        throw 'useExternal is set to true but externalCurrentPage is not set. Griddle will not page correctly without that property when using external data.';
	      }
	    }
	  },

	  verifyCustom: function verifyCustom() {
	    //TODO: PropTypes instead
	    if (this.props.useCustomGridComponent === true && this.props.customGridComponent === null) {
	      throw 'useCustomGridComponent is set to true but no custom component was specified.';
	    }
	    if (this.props.useCustomRowComponent === true && this.props.customRowComponent === null) {
	      throw 'useCustomRowComponent is set to true but no custom component was specified.';
	    }
	    if (this.props.useCustomGridComponent === true && this.props.useCustomRowComponent === true) {
	      throw 'Cannot currently use both customGridComponent and customRowComponent.';
	    }
	  },
	  ...
	  getTopSection: function getTopSection(filter, settings) {
	    ...
	    var settingsStyles = null;
	    var topContainerStyles = null;
	  ...
	  getCustomRowSection: function getCustomRowSection(data, cols, meta, pagingContent) {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(CustomRowComponentContainer, {
	        data: data,
	        columns: cols,
	...
	var GridTable = React.createClass({
	  ...
	  verifyProps: function verifyProps() {
	    if (this.props.columnSettings === null) {
	      //TODO: Use propTypes
	      throw 'gridTable: The columnSettings prop is null and it shouldn\'t be';
	    }
	    if (this.props.rowSettings === null) {
	      //TODO: use PropTypes
	      throw 'gridTable: The rowSettings prop is null and it shouldn\'t be';
	    }
	  },
	...
	var GridSettings = React.createClass({
	  ...
	  render: function render() {
	    ...
	    if (that.props.useCustomComponent === false) {
	      nodes = this.props.columns.map(function (col) {
	    ...
	    return React.createElement(
	      'div',
	      {
	        ...
	        style: this.props.useGriddleStyles ? { backgroundColor: '#FFF',
	      ...
	      React.createElement(
	        'div',
	        {
	          ...
	          style: this.props.useGriddleStyles ? { clear: 'both',
	            display: 'table',
	            width: '100%',
	...
	*/
	...
	var GridTitle = React.createClass({
	  ...
	  verifyProps: function verifyProps() {
	    if (this.props.columnSettings === null) {
	      //TODO: use propTypes
	      throw 'gridTitle: The columnSettings prop is null and it shouldn\'t be';
	    }

	    if (this.props.sortSettings === null) {
	      throw 'gridTitle: The sortSettings prop is null and it shouldn\'t be';
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var GridRowContainer = React.createClass({
	  ...
	  verifyProps: function verifyProps() {
	    if (this.props.columnSettings === null) {
	      //TODO: Seriously -- use propTypes
	      throw 'gridRowContainer: The columnSettings prop is null and it shouldn\'t be';
	    }
	  },
	  ...
	  render: function render() {
	    ...
	    if (that.state.showChildren) {
	      children = that.props.hasChildren && this.props.data['children'].map(function (row) {
	          ...
	          return React.createElement(
	            ...
	            React.createElement(
	              ...
	              { colSpan: that.props.columnSettings.getVisibleColumnCount(),
	                ...
	                style: that.props.useGriddleStyles ? { border: 'none', 'padding': '0 0 0 5px' } : null },
